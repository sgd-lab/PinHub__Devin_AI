...
const ERROR_PATTERNS: Array<{
  ...
  { pattern: /quota|exceeded|billing|insufficient/i, type: "quota", suggestion: "API quota exceeded. Check your plan limits or switch to a free provider like Gemini." },
